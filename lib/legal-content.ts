...
export const legalDocuments: LegalDocument[] = [
  ...
  },
  {
    ...
    sections: [
      ...
      { heading: 'Cancellations', paragraphs: ['Hosts can cancel an upcoming reservation through the host reservation tools when necessary. Guests should use the available reservation tools or contact the host through in-app messaging when a visit needs to change. The app displays the resulting reservation status.'] },
      { heading: 'Refunds', paragraphs: ['Refund availability and amount depend on the specific paid reservation and its actual payment status. ROVAH does not state a universal cancellation window or guaranteed refund amount in this baseline policy. When a Stripe payment has been refunded, the reservation’s payment record is updated accordingly.'] },
