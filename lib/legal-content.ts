...
export const legalDocuments: LegalDocument[] = [
  ...
  },
  {
    ...
    sections: [
      ...
      { heading: 'Questions', paragraphs: ['For privacy questions or requests, contact support@rovah.dog. This policy is a baseline document for attorney review before a broader public launch.'] },
    ],
  },
  {
