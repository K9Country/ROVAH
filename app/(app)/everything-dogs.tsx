...
const styles = StyleSheet.create({
  ...
  categoryImage: { borderRadius: 32.5, height: 65, marginRight: 15, width: 65 },
  trainingImage: { backgroundColor: colors.warmWhite, borderRadius: 32.5, height: 65, marginRight: 15, width: 65 },
  k9ProductsImage: { borderRadius: 32.5, height: 65, marginRight: 15, width: 65 },
  categoryCopy: { flex: 1 },
