    ...
    <SafeAreaView style={styles.safeArea}>
      <ScrollView contentContainerStyle={styles.container} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.bookingCard}>
          ...
          {!selectedCourtesyCreditId && reservationTotal > 0 ? <Text style={styles.paymentConsentText}>{selectedLoyaltyPassOffer ? 'By confirming, you authorize ROVAH to securely process the selected subscription and any additional-dog fee shown above.' : 'By confirming, you authorize ROVAH to securely process the displayed reservation total. Near-term visits are secured now; future visits save your card and charge it one hour before the visit. Cancel before then and no charge will be made.'}</Text> : null}
          <HostPageGuide
