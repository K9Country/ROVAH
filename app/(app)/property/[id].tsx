    ...
    <SafeAreaView style={styles.safeArea}>
      <ScrollView contentContainerStyle={styles.container} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.bookingCard}>
          ...
          <Pressable disabled={property.is_temporarily_closed || isBooking} onPress={reserveSpace} style={[styles.bookingButton, (property.is_temporarily_closed || isBooking) && styles.buttonDisabled]}>{isBooking ? <ActivityIndicator color={colors.warmWhite} /> : <Text style={styles.bookingButtonText}>{!bookingDate ? 'Choose a date to continue' : !startTime ? 'Choose a start time to continue' : !endTime ? 'Choose an end time to continue' : 'Confirm and Check Out'}</Text>}</Pressable>
        </View>
      </ScrollView>
