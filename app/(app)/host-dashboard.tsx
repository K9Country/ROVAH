...
const styles = StyleSheet.create({
  ...
  propertyToolPressable: { alignItems: 'center', backgroundColor: '#FFFFFF', flexDirection: 'row', minHeight: 92, paddingHorizontal: 15, paddingVertical: 14 },
  ...
  propertyToolArtwork: { height: 68, resizeMode: 'contain', width: 68 },
